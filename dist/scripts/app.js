...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fornac = __webpack_require__(2);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	// Reference Structure
	function referenceStructureContainer(structure, sequence) {
	    var container = new _fornac.FornaContainer("#rna_reference", {
	        'applyForce': true,
	...
	function predictedStructureContainer(structure, sequence, reactivity_array) {
	    var container = new _fornac.FornaContainer("#rna_predicted", {
	        'applyForce': true,
	        'allowPanningAndZooming': true,
	        'initialSize': [400, 400]
	    });
	...
	function updateRNASelection() {
	    ...
	    var $el = (0, _jquery2.default)("#rna_select");
	    $el.empty(); // remove old options
	    _jquery2.default.each(rna_id_array, function (index, value) {
	        $el.append((0, _jquery2.default)("<option></option>").attr("value", value).text(value));
	    });
	}

	function constructRNAStructureDict() {
	    _jquery2.default.each(rna_structure_array, function (index, value) {
	        var id = value['rna_id'];
	...
	function updatePageWithRNAID(rnaID) {
	    //
	    var rna = rna_structure_dict[rnaID];
	    var sequence = rna['sequence_string'];
	    var reference = rna['reference_structure'];
	    var predicted = rna['predicted_structure'];
	    var barcode = rna['barcode_string'];
	    var reactivity_array = rna['reactivity'];

	    (0, _jquery2.default)("#rna_id").html(rnaID);
	    (0, _jquery2.default)("#rna_barcode").html(barcode);
	    (0, _jquery2.default)("#rna_sequence").html(sequence);
	    (0, _jquery2.default)("#reference_structure").html(reference);
	    (0, _jquery2.default)("#predicted_structure").html(predicted);
	...
	var rna_id_array = [];
	var data_json = 'RNA_Library_Structure-2017-02-01.json';

	_jquery2.default.getJSON('data/' + data_json, function (json) {

	    // Update page
	    (0, _jquery2.default)("#date").html(json['date']);
	...
	(0, _jquery2.default)("#view_rna").click(function () {

	    var rnaID = (0, _jquery2.default)("#rna_select").val();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rnagraph = __webpack_require__(3);
	...
	var _rnaplot = __webpack_require__(5);
	...
	var _simplernaplot = __webpack_require__(6);

	var _rnautils = __webpack_require__(4);

	var _naview = __webpack_require__(7);
	...
	function FornaContainer(element, passedOptions) {
	    ...
	    */
	    ...
	    self.getBoundingBoxTransform = function () {
	        ...
	        var minRatio = Math.min(widthRatio, heightRatio, self.options.maxNodeRadius / maxRadius) * 0.9;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _radloop = __webpack_require__(8);
